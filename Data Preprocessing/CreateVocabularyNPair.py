...
################defining call variables##################
corpus_name = "redit_corpus"
corpus = os.path.join("data", corpus_name)
datafile = os.path.join(corpus, "test1.txt")
...
def readVocs(datafile, corpus_name):
    ...
    print(datafile)
    lines = open('data/redit_corpus/test1.txt', encoding='utf-8').\
        read().strip().split('\n')
...
def prepareData(corpus, corpus_name):
    ...
    print("further trimming less used words \n  ")
    pairs = trimRareWords(voc, pairs, MIN_COUNT)
    
    
    print("saving voc now \n  ")
    
    directory = '/home/ryan/stark/chatbot/data/save'
...
def loadPrepareData():
    ...
    try:
        ...
        #voc = torch.load(os.path.join('/home/ryan/stark/chatbot/data/save/voc.tar'))
        #pairs = torch.load(os.path.join('/home/ryan/stark/chatbot/data/save/pairs.tar'))
        voc = torch.load(os.path.join('/home/ryan/stark/chatbot/data/save/voc.tar'))
        pairs = torch.load(os.path.join('/home/ryan/stark/chatbot/data/save/pairs.tar'))
